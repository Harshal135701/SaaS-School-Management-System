...
const subjectRequirementRoutes = require("./routes/subjectRequirementRoutes");
...
const franchiseSettingsRoutes = require("./routes/franchiseSettingsRoutes");
...
const teacherSettingsRoutes = require("./routes/teacherSettingsRoutes");
const teacherMeRoutes = require("./routes/teacherMeRoutes");
...
app.use("/api/franchise/settings", franchiseSettingsRoutes);
...
app.use("/api/teacher/me", teacherMeRoutes);
...
app.use("/api/subject-requirements", subjectRequirementRoutes);
