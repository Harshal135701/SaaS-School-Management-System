...
export const RoyaltyPage: React.FC<RoyaltyPageProps> = ({
  ...
  const [statusFilter, _setStatusFilter] =
    useState<string>('All');
          ...
          const records = franchises
            .map((franchise: any) => {
              ...
              return {
                id: royalty.id,
                schoolName:
                  franchise.name || 'Unknown School',
                schoolCode: franchise.code || '-',

                invoiceNumber: `ROY-${
                  royalty.id?.slice(0, 8) || 'N/A'
                }`,
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 font-medium">
            Monitor platform royalty collections,
            configure pricing plans, track
            pending/overdue invoices, and export
            financial reports.
          </p>
        </div>
        ...
        <Button
          ...
          onClick={() => {
            showNotification(
              'Royalty Financial Report exported successfully (CSV/Excel)!'
            );
          }}
          leftIcon={
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4 border-slate-200/80">
          ...
          <span className="text-[11px] text-slate-500 font-medium mt-1 block">
            Active month across all schools
          </span>
        </Card>
        ...
        <Card className="p-4 border-slate-200/80 bg-emerald-50/30">
          ...
          <span className="text-[11px] text-emerald-600 font-extrabold mt-1 block">
        ...
        <Card className="p-4 border-slate-200/80 bg-rose-50/30">
          ...
          <span className="text-[11px] text-rose-700 font-extrabold mt-1 block">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <Card className="lg:col-span-2 p-6 border-slate-200/80">
              <h3 className="text-base font-extrabold text-slate-900">
                Current Royalty Collection
              </h3>

              <p className="text-xs text-slate-500 font-medium mb-4">
                Current monthly royalty status across
                all franchises
              </p>
        ...
        <Card className="p-6 border-slate-200/80 space-y-4">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1">
              Royalty configuration will be loaded
              from the backend.
            </p>
          </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {loading ? (
                  <tr>
                    <td
                      colSpan={8}
                      className="p-6 text-center text-slate-400 font-semibold text-xs"
                    >
                      ...
                      <td className="p-3.5 text-right">
                        ...
                        'Overdue' ? (
                          <Button
                            ...
                            onClick={() =>
                              showNotification(
                                `Payment reminder dispatched to ${r.schoolName} admin!`
                              )
                            }
                            leftIcon={
                          ...
                          <Button
                            ...
                            onClick={() =>
                              showNotification(
                                `Viewing invoice details for ${r.invoiceNumber}`
                              )
                            }
                          >
                            Invoice
      ...
      {activeTab === 'reports' && (
        <Card className="p-6 border-slate-200/80 space-y-6">
          <div>
            <h3 className="text-base font-extrabold text-slate-900">
              Royalty Financial Reporting & Data
              Export
            </h3>

            <p className="text-xs text-slate-500 font-medium">
              Filter payment logs across dates,
              plans, and statuses to generate
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-200/80">
            ...
            <div>
              ...
              <select className="w-full bg-white border border-slate-200 rounded-xl p-2 text-xs font-semibold text-slate-800">
                <option>
                  All Schools ({royaltyList.length})
                </option>
            ...
            <div className="flex items-end">
              <Button
                ...
                onClick={() =>
                  showNotification(
                    'Generated custom royalty report!'
                  )
                }
                leftIcon={
