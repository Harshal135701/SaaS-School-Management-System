          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            >
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 flex items-center gap-2">
                <button
                  ...
                  className={`flex-1 py-1 px-2 rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer ${statusFilter === 'Active'
                ...
                <button
                  ...
                  className={`flex-1 py-1 px-2 rounded-lg text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer ${statusFilter === 'Inactive'
            ...
            >
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between">
                ...
                <span className={`px-2 py-0.5 rounded-full text-[10px] font-extrabold ${pendingRoyaltyTotal > 0
            ...
            >
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between">
                ...
                <span className={`px-2 py-0.5 rounded-full text-[10px] font-extrabold ${overdueRoyaltyTotal > 0
            ...
            >
              ...
              <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between">
                ...
                <span className={`px-2 py-0.5 rounded-full text-[10px] font-extrabold ${expiringContractsCount > 0
                  ? 'bg-rose-50 text-rose-700 border border-rose-200/60'
                  : 'bg-emerald-50 text-emerald-700 border border-emerald-200/60'
                  }`}>
                ...
                {(
                  ...
                  (range) => (
                    ...
                    <button
                      ...
                      className={`px-3 py-1.5 text-xs font-bold rounded-lg transition-all cursor-pointer ${timeRange ===
                        range
                  ...
                  {[
                    ...
                    (status) => (
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg transition-colors cursor-pointer ${statusFilter ===
                          status
                  ...
                  {[
                    ...
                    (plan) => (
                      ...
                      <button
                        ...
                        className={`px-2.5 py-1 rounded-lg transition-colors cursor-pointer ${planFilter ===
                          plan
                          ? 'bg-white text-slate-900 shadow-xs font-bold'
                          : 'text-slate-600'
                          }`}
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="p-3.5">
                              ...
                              <span
                                className={`px-2 py-0.5 rounded-md font-extrabold text-[10px] uppercase ${plan.toUpperCase() ===
                                  'ENTERPRISE'
                            ...
                            <td className="p-3.5">
                              ...
                              <span
                                className={`inline-flex items-center gap-1 text-[11px] font-bold ${isActive
                                  ? 'text-emerald-600'
                                  : 'text-slate-400'
                                  }`}
                              >
